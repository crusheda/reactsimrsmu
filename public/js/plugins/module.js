    ...
    H = function () {
        ...
        return t.prototype.init = function () {
            ...
            for (var a, o, r, l, d, c = function (t, e, s) {
                ...
                }(t, e, s), u = c.gaps1, p = c.gaps2, f = t.childNodes.slice(), m = e.childNodes.slice(), g = Math.min(u.length, p.length), b = [], v = 0, w = 0; v < g; w += 1, v += 1)
                if (!n || !0 !== u[v] && !0 !== p[v]) {
                    if (!0 === u[w])
                        if ("#text" === (l = f[w]).nodeName)
                            if ("#text" === m[v].nodeName) {
                                if (l.data !== m[v].data) {
                                    for (var _ = w; f.length > _ + 1 && "#text" === f[_ + 1].nodeName;)
                        ...
                        nodeName: "#text",
                        data: l.data
                    }), g = Math.min(u.length, p.length)) : (b.push((new h).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.element, D(l))), u.splice(w, 0, !0), f.splice(w, 0, D(l)), g = Math.min(u.length, p.length));
                    else if (u[w] !== p[v]) {
...
export {
    it as DataTable, mt as addColumnFilter, nt as convertCSV, at as convertJSON, s as createElement, ot as exportCSV, rt as exportJSON, lt as exportSQL, dt as exportTXT, e as isJson, t as isObject, ut as makeEditable
};
