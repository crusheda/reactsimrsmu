! function () {
    ...
    var r = "",
        ...
        a = new FullCalendar.Calendar(document.getElementById("calendar"), {
            ...
            select: function (e) {
                var t = new Date(e.start),
                    e = new Date(e.end);
                document.getElementById("pc-e-sdate").value = t.getFullYear() + "-" + o(t.getMonth() + 1) + "-" + o(t.getDate()), document.getElementById("pc-e-edate").value = e.getFullYear() + "-" + o(e.getMonth() + 1) + "-" + o(e.getDate()), document.getElementById("pc-e-title").value = "", document.getElementById("pc-e-venue").value = "", document.getElementById("pc-e-description").value = "", document.getElementById("pc-e-type").value = "", document.getElementById("pc-e-btn-text").innerHTML = '<i class="align-text-bottom me-1 ti ti-calendar-plus"></i> Add', document.querySelector("#pc_event_add").setAttribute("data-pc-action", "add"), l.show(), a.unselect()
            },
            eventClick: function (e) {
                ...
                document.querySelector(".calendar-modal-title").innerHTML = t, document.querySelector(".pc-event-title").innerHTML = t, document.querySelector(".pc-event-description").innerHTML = n, document.querySelector(".pc-event-date").innerHTML = a + i, document.querySelector(".pc-event-venue").innerHTML = e, d.show()
            },
            events: [{
                title: "All Day Event",
                ...
                title: "Meeting",
                start: new Date(e, t, 12, 10, 30),
                end: new Date(e, t, 12, 12, 30),
                allDay: !1,
                description: "It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.",
                venue: "City Town",
                className: "event-danger"
                ...
                description: "It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.",
                venue: "City Town",
                start: new Date(e, t, 28)
            }]
        }),
        e = (a.render(), document.addEventListener("DOMContentLoaded", function () {
        ...
        t = (i && i.addEventListener("click", function () {
            var e = null,
            ...
            }), "add" == i.getAttribute("data-pc-action") ? Swal.fire({
                customClass: {
            ...
            }) : (r.remove(), document.getElementById("pc-e-btn-text").innerHTML = '<i class="align-text-bottom me-1 ti ti-calendar-plus"></i> Add', document.querySelector("#pc_event_add").setAttribute("data-pc-action", "add"), Swal.fire({
                customClass: {
                    confirmButton: "btn btn-light-primary"
                },
                buttonsStyling: !1,
