                ...
                <li class="list-group-item">
                    ...
                    <div class="theme-color preset-color"><a href="#!" data-bs-toggle="tooltip" title="Blue"
                        ...
                        <a href="#!" data-bs-toggle="tooltip" title="Indigo" data-value="preset-2"><i
                            ...
                            title="Purple" data-value="preset-3"><i class="ti ti-checks"></i></a> <a href="#!"
                            data-bs-toggle="tooltip" title="Pink" data-value="preset-4"><i
                                class="ti ti-checks"></i></a> <a href="#!" data-bs-toggle="tooltip"
                            title="Red" data-value="preset-5"><i class="ti ti-checks"></i></a> <a href="#!"
                            data-bs-toggle="tooltip" title="Orange" data-value="preset-6"><i
                                class="ti ti-checks"></i></a> <a href="#!" data-bs-toggle="tooltip"
                            title="Yellow" data-value="preset-7"><i class="ti ti-checks"></i></a> <a href="#!"
                            data-bs-toggle="tooltip" title="Green" data-value="preset-8"><i
                                class="ti ti-checks"></i></a> <a href="#!" data-bs-toggle="tooltip"
                            title="Teal" data-value="preset-9"><i class="ti ti-checks"></i></a> <a href="#!"
                ...
                {{-- <li class="list-group-item">
                    ...
                    <div class="theme-main-layout d-flex align-center gap-1 w-100"><a href="#!"
                            data-bs-toggle="tooltip" title="Vertical" class="active" data-value="vertical"><img
                                src="{{ asset('images/customizer/caption-on.svg') }}" alt="img"
                                class="img-fluid">
                        </a><a href="#!" data-bs-toggle="tooltip" title="Horizontal"
                            data-value="horizontal"><img src="{{ asset('images/customizer/horizontal.svg') }}"
                                alt="img" class="img-fluid"> </a><a href="#!" data-bs-toggle="tooltip"
                            title="Color Header" data-value="color-header"><img
                                src="{{ asset('images/customizer/color-header.svg') }}" alt="img"
                                class="img-fluid">
                        </a><a href="#!" data-bs-toggle="tooltip" title="Compact" data-value="compact"><img
                                src="{{ asset('images/customizer/compact.svg') }}" alt="img" class="img-fluid">
                    ...
                    <div class="row theme-color theme-nav-caption">
                        <div class="col-6">
                            <div class="d-grid"><button class="preset-btn btn-img btn active" data-value="true"
                                    ...
                                    title="Caption Show"><img src="{{ asset('images/customizer/caption-on.svg') }}"
                        ...
                        <div class="col-6">
                            <div class="d-grid"><button class="preset-btn btn-img btn" data-value="false"
                                    ...
                                    title="Caption Hide"><img src="{{ asset('images/customizer/caption-off.svg') }}"
                                        alt="img" class="img-fluid"></button></div>
                        </div>
                    </div>
                </li>
                        ...
                        <div class="row theme-color theme-direction">
                            <div class="col-6">
                                <div class="d-grid"><button class="preset-btn btn-img btn active" data-value="false"
                                        ...
                                        title="LTR"><img src="{{ asset('images/customizer/ltr.svg') }}"
                                            alt="img" class="img-fluid"></button></div>
                            </div>
                            <div class="col-6">
                                <div class="d-grid"><button class="preset-btn btn-img btn" data-value="true"
                                        ...
                                        title="RTL"><img src="{{ asset('images/customizer/rtl.svg') }}"
                                            alt="img" class="img-fluid"></button></div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row theme-color theme-container">
                            <div class="col-6">
                                <div class="d-grid"><button class="preset-btn btn-img btn active" data-value="false"
                                        ...
                                        title="Full Width"><img src="{{ asset('images/customizer/full.svg') }}"
                                            alt="img" class="img-fluid"></button></div>
                            </div>
                            <div class="col-6">
                                <div class="d-grid"><button class="preset-btn btn-img btn" data-value="true"
                                        onclick="change_box_container('true')" data-bs-toggle="tooltip"
                                        title="Fixed Width"><img src="{{ asset('images/customizer/fixed.svg') }}"
                                            alt="img" class="img-fluid"></button></div>
                            </div>
                        </div>
                    </div>
