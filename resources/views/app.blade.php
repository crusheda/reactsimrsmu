...
<head>
    ...
    <!-- Prism CSS -->
    <link rel="stylesheet" href="{{ asset('react/libs/prismjs/themes/prism-coy.min.css') }}">
...
<body>
    ...
    <!-- Custom JS -->
    <script src="{{ asset('react/js/modal.js') }}"></script>
    ...
    <!-- DataTables JS -->
    <script src="{{ asset('react/libs/prismjs/prism.js') }}"></script>
    <script src="{{ asset('react/js/prism-custom.js') }}"></script>
