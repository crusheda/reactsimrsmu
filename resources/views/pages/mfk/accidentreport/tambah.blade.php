            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h2 class="mb-0">Form Tambah Kecelakaan Kerja</h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row pt-1">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-auth-small needs-validation" name="formTambah" action="{{ route('accidentreport.store') }}" method="POST" enctype="multipart/form-data" novalidate>
                        @csrf
                        <div class="row">
                            <div class="col-md-12"><div class="alert alert-secondary p-3"><h4 class="mb-0 text-primary text-center">A. Identifikasi Kecelakaan</h4></div></div>
                            <div class="col-md-4">
