            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h2 class="mb-0">Ubah Akun Pengguna</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header d-flex align-items-center justify-content-between py-3">
                    <button class="btn btn-outline-dark" onclick="window.location.href='{{ route('akunpengguna.index') }}'"><i class="fas fa-angle-left me-1"></i> Kembali</button>
                    <h5 class="mb-0">Form Ubah <kbd>ID # {{ $list['user']->id }}</kbd></h5>
                </div>
                <div class="card-body pb-2">
                    {{ Form::model($list['user'], ['route' => ['akunpengguna.update', $list['user']->id], 'method' => 'PUT', 'id' => 'formUbah']) }}
                        <div class="row">
                            <h5 class="font-size-14 text-center"><i class="mdi mdi-arrow-right text-primary"></i> Password will be Encrypted with <b class="text-primary"><i>Laravel Bcrypt Hash</i></b></h5>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <button class="btn btn-outline-primary" type="button" id="open-password1"><i
                                                class="fas fa-eye-slash" id="icon-password1"></i></button>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <button class="btn btn-outline-primary" type="button" id="open-password2"><i
                                                class="fas fa-eye-slash" id="icon-password2"></i></button>
                                    </div>
                                </div>
                            </div>
