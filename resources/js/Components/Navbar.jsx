            ...
            <div className="main-header-container container-fluid">
                <div className="header-content-left">
                    ...
                    <div className="header-element header-search header-search-content d-md-block d-none">
                        <input type="text" className="header-search-bar form-control bg-white" id="header-search" placeholder="Search" spellCheck="false" autoComplete="off" autoCapitalize="off" />
                        <a role="button" className="header-search-icon border-0">
                    ...
                    <li className="header-element notifications-dropdown dropdown d-xl-block d-none">
                        ...
                        <div className="main-header-dropdown dropdown-menu dropdown-menu-end">
                            <div className="p-3 bg-primary text-fixed-white d-flex justify-content-between">
                                ...
                                <a role="button" className="badge bg-light text-default border">Clear All</a>
                            </div>
                            <div className="dropdown-divider"></div>
                            <ul className="list-unstyled mb-0">
                                <li className="dropdown-item">New Message from John</li>
                                <li className="dropdown-item">Task Reminder: Submit report</li>
                                <li className="dropdown-item">Friend Request from Jane</li>
                                <li className="dropdown-item">Event Reminder: Team Meeting</li>
                            </ul>
                        </div>
                    </li>
                        ...
                        <div className="main-header-dropdown dropdown-menu dropdown-menu-end">
                            ...
                            <div className="p-3">
                                <div className="d-flex align-items-start gap-2">
                                    ...
                                    <div>
                                        <span className="d-block fw-semibold lh-1">{auth?.user?.nama || auth?.user?.name}</span>
                                        <span className="text-muted fs-12">{auth?.user?.email || 'Tidak Ada Email'}</span>
                                    </div>
                                </div>
                            </div>
                            <div className="dropdown-divider"></div>
                            <ul className="list-unstyled mb-0">
                                <li><a className="dropdown-item" role='button'>Lihat Profil</a></li>
                                <li><a className="dropdown-item" role='button' onClick={logout}>Log Out</a></li>
                            </ul>
                        </div>
                    </li>
